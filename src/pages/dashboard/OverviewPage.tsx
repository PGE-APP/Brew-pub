...
import { OperationsPanel } from "../../components/dashboard/panels/OperationsPanel";
import { ProductionOverviewChart } from "../../components/dashboard/charts/ProductionOverviewChart";
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className={cn("min-h-screen transition-[margin] duration-300", sidebarOpen ? "lg:ml-64" : "lg:ml-0")}>
        <Topbar title="แดชบอร์ดภาพรวมการผลิตและการกำกับดูแล" onMenuClick={() => setSidebarOpen((prev) => !prev)} />
